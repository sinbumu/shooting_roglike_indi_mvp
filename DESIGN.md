...
> 마지막 점검: **2026-08-19** — **v1.8.2 근접·장판·스웜 스프라이트** (온라인·외부 애널리틱스만 보류)
...
- [x] 성장: 레벨업 3선택지, 슬롯 5, 패시브 4, Tier1→2→3 (26무기/21레시피, 동형 조합·진화 포함)  
...
| `public/assets/sprites/fx_*.png` | 근접·장판·스웜 2×2 애니메이션 시트 (v1.8.2) |
