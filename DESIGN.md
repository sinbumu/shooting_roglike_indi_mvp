...
> 마지막 점검: **2026-08-20 — v1.11.0** (온라인·외부 애널리틱스만 보류)
...
| 항목 | 현재 |
|---|---|
| 버전 | **v1.11.0** (`package.json` / 격납고 패치 노트와 동일) |
...
| 분류 | 내용 |
|---|---|
| 스테이지 | `orbit` → `rift` → `legion` → `blitz` (클리어 해금, 군단 7분 · 심연 강하 3분 EXP 3배) |
| 도전 | 표준 / 제한무장 / 유리장갑 / 맨몸 |
