...
> 마지막 점검: **2026-08-20 — v1.12.0** (온라인·외부 애널리틱스만 보류)
...
| 템포 압축 | 클리어 판테온 · 운명 성좌 6노드 · 심연 강하(3분 EXP 3배) | [v1.11.0](./docs/DESIGN_UPDATE_V1_11_0_ENDGAME_PACING.md) |
| 맵 크래프팅 | 심연 강하 모디파이어 · 도플갱어 난입 · 공허 보급상자 | [v1.12.0](./docs/DESIGN_UPDATE_V1_12_0_MODIFIERS_NEMESIS.md) |
...
- [x] v1.11.0: 클리어 판테온 · 운명 성좌 6노드(가중치 ×3) · 심연 강하 3분 파밍 
- [x] v1.12.0: 공허 맵 크래프팅(모디파이어) · 도플갱어 섀도우 컴뱃 · 공허 보급상자 
...
| 분류 | 내용 |
|---|---|
| 스테이지 | `orbit` → `rift` → `legion` → `blitz` (클리어 해금, 군단 7분 · 심연 강하 3분 EXP 3배 · 출격 전 모디파이어) |
| 도전 | 표준 / 제한무장 / 유리장갑 / 맨몸 |
...
| 성좌 | 클리어·만렙 공명 판테온 포인트 · 격납고 **28노드**(운명 6) 보드 · 다음 런 룰 분기 |
...
균열(4:30)·군단(7:00, 60초마다 군단장)·심연 강하(3:00, EXP 3배)는 타임·웨이브·스토리가 다름 → `GameConfig.ts`의 `STAGES` 참고.
...
| [docs/DESIGN_UPDATE_V1_11_0_ENDGAME_PACING.md](./docs/DESIGN_UPDATE_V1_11_0_ENDGAME_PACING.md) | v1.11.0 클리어 판테온 · 운명 성좌 · 심연 강하 |
| [docs/DESIGN_UPDATE_V1_12_0_MODIFIERS_NEMESIS.md](./docs/DESIGN_UPDATE_V1_12_0_MODIFIERS_NEMESIS.md) | v1.12.0 공허 모디파이어 · 도플갱어 |
