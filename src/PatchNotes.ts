...
export const PATCH_NOTES: PatchNote[] = [
  {
    ...
    date: '2026-08-22',
    changes: [
      '🧪 연금술 라인: 유해 물질(회복→맹독 장판) · 전자기 폭주(자석→5초 버프, 비중첩) · 등가 교환(폭탄→체력 반감·드랍 ×1.5)',
      '📜 돌발 임무: 피의 계약(중반 마법진 10초) · 긴급 현상수배(엘리트 15초 3배) · 저주받은 보급상자(열기/지나치기)',
      '🧬 돌연변이: 시체 폭발 · 황금 드론(배회 후 도주, 100–200c) · 분열하는 그림자(엘리트 유지·더 단단함)',
    ],
  },
  {
    version: 'v1.13.0',
