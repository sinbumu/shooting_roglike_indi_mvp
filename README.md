...
| | |
|---|---|
| **현재 버전** | **v1.11.0** (2026-08-20) — 로컬 완결형 빌드. 온라인·외부 애널리틱스만 보류 |
...
- 스테이지 4종 (궤도 → 균열 → 군단 → **심연 강하**, 클리어 해금) + 도전 4종
- 무기 **55종** (탄막 트리 + 근접/장판 + 매트릭스 채찍·소환·핏빛·교차 4트리) · 런 중 패시브 16 · 보스 2종
- **기체 개성:** 야차(근접만·거합도) / 오버로드(소환 지휘·군단 폭주) / 크림슨(광분·혈사포) 포함
- **엔드게임:** 한계 돌파 · EMP/쉴드/자석폭주 · T0 어픽스 · 잭팟 · 돌발 균열 · 공허의 제단 · 스테이지 재해 · **Lv.50 코어 각성** · 성좌 **28노드**(운명 가중치)
...
🌀 채찍 / 🕷️ 스파이더 / 🩸 핏빛 쐐기
  ...
  → 요격기·포탑·톱니드론
  → 착취오라·출혈·피의추적자
  → 부메랑참격 / 산탄폭뢰 / 맹독거미줄 / 핏빛기관포
  → 명왕톱·환영검무·지각절단기
  → 둠스데이·궤도폭격·아이언메이든
  → 처형대·혈노바·흡혈박쥐
  → 영겁차크람·클러스터데스밤·절대구속·십자포화
```
